...
// World grid: the game now renders the hand-authored start island
// (startIsland.json), which is 40×30 tiles. The camera follows the player and
// the island floats on the tiled-water backdrop.
