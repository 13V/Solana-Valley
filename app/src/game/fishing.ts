...
export const FISH: Fish[] = [
  ...
  // Uncommon
  { id: 'perch', name: 'Perch', rarity: 'Uncommon', value: 55, frame: 13, weight: 52, water: 'fresh' },
  { id: 'goldfish', name: 'Goldfish', rarity: 'Uncommon', value: 75, frame: 0, weight: 52, water: 'fresh' },
  { id: 'shrimp', name: 'Pond Shrimp', rarity: 'Uncommon', value: 95, frame: 9, weight: 52, water: 'any' },
  // Rare
  { id: 'bass', name: 'Largemouth Bass', rarity: 'Rare', value: 150, frame: 21, weight: 22, water: 'fresh' },
  { id: 'trout', name: 'Rainbow Trout', rarity: 'Rare', value: 230, frame: 20, weight: 22, water: 'any' },
  { id: 'catfish', name: 'Catfish', rarity: 'Rare', value: 380, frame: 59, weight: 22, water: 'fresh' },
  { id: 'snapper', name: 'Red Snapper', rarity: 'Rare', value: 300, frame: 11, weight: 22, water: 'salt' },
  // Legendary
  { id: 'pufferfish', name: 'Pufferfish', rarity: 'Legendary', value: 520, frame: 38, weight: 9, water: 'salt' },
  { id: 'angelfish', name: 'Blue Angelfish', rarity: 'Legendary', value: 780, frame: 68, weight: 9, water: 'salt' },
  // Mythical
  { id: 'manta', name: 'Manta Ray', rarity: 'Mythical', value: 1500, frame: 41, weight: 3.5, water: 'salt' },
  { id: 'betta', name: 'Crimson Betta', rarity: 'Mythical', value: 2400, frame: 10, weight: 3.5, water: 'fresh' },
  // Divine
  { id: 'swordfish', name: 'Swordfish', rarity: 'Divine', value: 5200, frame: 57, weight: 1.2, water: 'salt' },
  { id: 'ghostshark', name: 'Ghost Shark', rarity: 'Divine', value: 8500, frame: 29, weight: 1.2, water: 'salt' },
  // Prismatic
  { id: 'prismtang', name: 'Prism Tang', rarity: 'Prismatic', value: 17000, frame: 45, weight: 0.35, water: 'salt' },
  { id: 'axolotl', name: 'Rainbow Axolotl', rarity: 'Prismatic', value: 30000, frame: 48, weight: 0.35, water: 'fresh' },
  // Celestial — the white whales.
  { id: 'kraken', name: 'Void Kraken', rarity: 'Celestial', value: 66000, frame: 24, weight: 0.1, water: 'salt' },
  { id: 'eel', name: 'Leviathan Eel', rarity: 'Celestial', value: 140000, frame: 64, weight: 0.1, water: 'any' },
];
...
export function catchFish(luck = 1, water: WaterKind = 'any'): Fish {
  ...
  const weights = pool.map((f) => f.weight * (1 + (luck - 1) * rarityRank(f.rarity) * 0.3));
