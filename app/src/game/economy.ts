...
export const PLANTS: Plant[] = [
  // Roster trimmed to crops with dedicated icon art (the pack has only ~14
  // distinct crop sprites; the rest were tint-only duplicates). Spans every
  // rarity tier Common -> Celestial.
