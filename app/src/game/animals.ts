...
export const ANIMALS: AnimalDef[] = [
  {
    ...
    productName: 'Egg', productValue: 200, layMs: 30_000, xp: 6,
  ...
  },
  {
    ...
    productName: 'Milk', productValue: 1000, layMs: 60_000, xp: 16,
  ...
  tree('apple', 'Apple Tree', 50_000, 4, 1500, 45_000, 14),
  tree('orange', 'Orange Tree', 90_000, 8, 3300, 55_000, 22),
  tree('peach', 'Peach Tree', 150_000, 12, 7000, 70_000, 34),
  tree('pear', 'Pear Tree', 250_000, 16, 14000, 85_000, 50),
];
